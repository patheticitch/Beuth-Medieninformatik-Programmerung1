...
public class MoreMethods {
	...
	public static String createCharSeries(char startChar, int anzahl){
		...
		int count=1; //counting the strings starts at one
		for (char i=startChar;i<startChar+anzahl;i++) {	
			if((count%10==0 && count !=0) || count==anzahl) {	//puts a new line every 10 characters and at the end ignoring the first character
	...
	public static void printCharSeries(PrintWriter out, char startChar, int anzahl) {
		out.println(createCharSeries(startChar, anzahl));
	}
